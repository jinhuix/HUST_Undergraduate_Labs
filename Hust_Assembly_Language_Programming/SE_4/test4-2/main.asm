...
.model flat,c
 ...
 public str6,str7,str8,str10,buf,midf,bname,bpass
...
;与反跟踪和加密有关
__t1		dd	?   ;记录运行时间，查看程序是否被反跟踪
__t2		dd	?
strr db  0e8h,3ch,0edh,0ffh,0ffh
len=$-strr
str11 db '不要想反跟踪',0ah,0
oldprotect dd ?

;输出用到的字符串
bpass db 'U' xor 'H','2','0' xor 'A','2','0' xor 'O','1','1' xor 'E','6','7','5',0
bname db 'xujinhui',0
str1 db '用户名: ',0
str2 db '密码: ',0
